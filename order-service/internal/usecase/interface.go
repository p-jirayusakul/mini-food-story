...
type Usecase interface {
	...
	GetCurrentOrderItems(ctx context.Context, sessionID uuid.UUID, pageNumber, pageSize int64) (result domain.SearchCurrentOrderItemsResult, customError *exceptions.CustomError)
	...
	GetOrderItems(ctx context.Context, orderID int64, pageNumber, pageSize int64) (result domain.SearchCurrentOrderItemsResult, customError *exceptions.CustomError)
	UpdateOrderItemsStatusByID(ctx context.Context, payload shareModel.OrderItemsStatus) (customError *exceptions.CustomError)
	...
	GetSessionIDByOrderID(ctx context.Context, orderID int64) (result uuid.UUID, customError *exceptions.CustomError)
