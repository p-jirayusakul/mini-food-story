...
type Usecase interface {
	...
	GetCurrentOrderItems(ctx context.Context, sessionID uuid.UUID, search domain.SearchOrderItems) (result domain.SearchOrderItemsResult, customError *exceptions.CustomError)
