...
import (
	"context"
	"fmt"
	"food-story/menu-service/internal/app"
...
func initSwagger(cfg config.Config) {
	...
	docs.SwaggerInfo.Title = "Menu Service API"
	docs.SwaggerInfo.Description = "REST API for managing restaurant menus, including menu items, categories, pricing and availability"
